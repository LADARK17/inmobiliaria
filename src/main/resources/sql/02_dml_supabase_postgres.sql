-- =====================================================================
-- PROYECTO INMOBILIARIA WEB MVC - DATOS DE PRUEBA SUPABASE (POSTGRESQL)
-- =====================================================================
...
-- 8. PERFIL (Relación 1:1, 12 registros)
...
-- 10. IMAGEN_PROPIEDAD (15 registros)
...
-- 15. DOCUMENTO_SOLICITUD (10 registros)
...
-- Sincronizar secuencias SERIAL para que los nuevos INSERT funcionen sin colisión
SELECT setval(pg_get_serial_sequence('ciudad', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM ciudad;
SELECT setval(pg_get_serial_sequence('tipo_propiedad', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM tipo_propiedad;
SELECT setval(pg_get_serial_sequence('caracteristica', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM caracteristica;
SELECT setval(pg_get_serial_sequence('inmobiliaria', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM inmobiliaria;
...
SELECT setval(pg_get_serial_sequence('perfil', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM perfil;
SELECT setval(pg_get_serial_sequence('propiedad', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM propiedad;
SELECT setval(pg_get_serial_sequence('imagen_propiedad', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM imagen_propiedad;
SELECT setval(pg_get_serial_sequence('favorito', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM favorito;
SELECT setval(pg_get_serial_sequence('cita', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM cita;
SELECT setval(pg_get_serial_sequence('solicitud', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM solicitud;
SELECT setval(pg_get_serial_sequence('documento_solicitud', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM documento_solicitud;
SELECT setval(pg_get_serial_sequence('auditoria', 'id'), COALESCE(MAX(id), 0) + 1, false) FROM auditoria;
